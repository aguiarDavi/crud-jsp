                    ...
                    <div class="card-body">
                        <form action="addSongToDB" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input id="title" type="text" class="form-control" name="title" style="width: 66vw" required onblur="validateTitle()">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input id="artist" type="text" class="form-control" name="artist" style="width: 66vw" required onblur="validateArtist()">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input id="album" type="text" class="form-control" name="album" style="width: 66vw" onblur="validateAlbum()">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input id="genre" type="text" class="form-control" name="genre" style="width: 66vw" required onblur="validateGenre()">
                                </div>
                            </div>
