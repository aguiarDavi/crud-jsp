                ...
                <div class="card-body">
                    <form action="editSongToDB" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="title" style="width: 66vw" value="${song.title}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="artist" style="width: 66vw" value="${song.artist}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="album" style="width: 66vw" value="${song.album}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="genre" style="width: 66vw" value="${song.genre}" required>
                            </div>
                        </div>
